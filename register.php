    ...
    <div class="w-full lg:w-1/2 bg-[#0C0D10] text-white flex flex-col p-8 sm:p-16 lg:px-24 justify-center">
        <div class="max-w-md w-full mx-auto">
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-sm"><span class="px-3 bg-[#0C0D10] text-gray-400">or register with</span></div>
            </div>

            <a href="google-login.php"
               class="flex items-center justify-center gap-3 w-full bg-transparent border border-gray-600 hover:border-gray-500 text-white font-medium py-3 px-4 rounded-xl transition-colors mb-6">
            ...
            <div class="relative mb-6">
                <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-gray-600"></div></div>
                <div class="relative flex justify-center text-sm"><span class="px-3 bg-[#0C0D10] text-gray-400">or use email</span></div>
            </div>
